...
class ConnectionManager:
    def __init__(self, host='0.0.0.0', port=5001, use_ssl=False):
        """Initialize the central server connection manager (encryption disabled)"""
        logging.info("Initializing Central Server Connection Manager (encryption disabled)")
        ...
        # Use the encryption manager (no actual encryption)
    ...
    def start(self):
        ...
        try:
            ...
            logging.info(f"Central server started on {self.host}:{self.port} (encryption disabled)")
    ...
    def handle_client(self, client_socket, address):
        ...
        try:
            ...
            log_connection(address, action="established connection (encryption disabled)")
            ...
            # Send encryption key for protocol compatibility
