...
class CentralServerTab:
    ...
    def create_central_server_tab(self):
        ...
        self._create_password_change_section()
        self._create_admin_section()
    ...
    def _create_password_change_section(self):
        """Create the password change section - available to all users"""
    ...
    def _create_admin_section(self):
        ...
        # User creation form
        self._create_user_creation_form()

        # User management section
        self._create_user_management_section()

    def _create_user_creation_form(self):
