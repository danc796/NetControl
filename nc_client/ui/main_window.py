...
from nc_client.ui.software_tab import SoftwareTab  # Import the new Software tab
...
class MainWindow(ctk.CTk):
    ...
    def create_main_ui(self):
        ...
        self.software_tab = SoftwareTab(self, self.notebook, self)  # Add the Software tab
    ...
    def on_computer_select(self, connection_id):
        ...
        if connection_id:
            ...
            if self.active_connection != connection_id:
                ...
                # If software tab exists and is loaded, refresh it with the new connection
                if hasattr(self, 'software_tab') and self.active_tab == "Software":
                    self.software_tab.refresh_software_list()
        else:
            self.active_connection = None
